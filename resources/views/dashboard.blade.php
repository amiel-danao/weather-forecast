            ...
            <div class="card card-chart">
                <div class="card-header ">
                    <div class="col-sm-6 text-left">
                        <h2 class="card-title">User Subscribed</h2>
                        <h5 class="card-category">As of {{ strftime('%A, %B %e, %Y %I:%M:%S %p', now()->timestamp) }}</h5>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-chart">
                <div class="card-header ">
                    <div class="col-sm-6 text-left">
                        <h2 class="card-title">Weather Update</h2>
                        <h5 class="card-category">As of {{ strftime('%A, %B %e, %Y %I:%M:%S %p', now()->timestamp) }}</h5>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <h4 class="text-center font-weight-bold">7 Day Forecast</h4>
                        </div>
                    </div>
                    <div class="col-md-12 d-flex justify-content-around pl-0 pr-0">
                        ...
                        <div class="card" style="background-color: transparent;">
                            <div class="card-body">
                                <img src="{{ asset('weather-assets') }}/rain.svg" height="70" width="150">
                                <p class="text-center font-weight-bold" style="font-size: 9px;">Monday</p>
                                <p class="text-center font-weight-bold mt-4" style="font-size: 10px;">Chances of rainfall</p>
                                <p class="text-center font-weight-bold mt-2" style="font-size: 10px;">0.5%</p>
                            </div>
                        </div>
                        <div class="card" style="background-color: transparent;">
                            <div class="card-body">
                                <img src="{{ asset('weather-assets') }}/rain.svg" height="70" width="150">
                                <p class="text-center font-weight-bold" style="font-size: 9px;">Tuesday</p>
                                <p class="text-center font-weight-bold mt-4" style="font-size: 10px;">Chances of rainfall</p>
                                <p class="text-center font-weight-bold mt-2" style="font-size: 10px;">0.5%</p>
                            </div>
                        </div>
                        <div class="card" style="background-color: transparent;">
                            <div class="card-body">
                                <img src="{{ asset('weather-assets') }}/rain.svg" height="70" width="150">
                                <p class="text-center font-weight-bold" style="font-size: 9px;">Wednesday</p>
                                <p class="text-center font-weight-bold mt-4" style="font-size: 10px;">Chances of rainfall</p>
                                <p class="text-center font-weight-bold mt-2" style="font-size: 10px;">0.5%</p>
                            </div>
                        </div>
                        <div class="card" style="background-color: transparent;">
                            <div class="card-body">
                                <img src="{{ asset('weather-assets') }}/rain.svg" height="70" width="150">
                                <p class="text-center font-weight-bold" style="font-size: 9px;">Thursday</p>
                                <p class="text-center font-weight-bold mt-4" style="font-size: 10px;">Chances of rainfall</p>
                                <p class="text-center font-weight-bold mt-2" style="font-size: 10px;">0.5%</p>
                            </div>
                        </div>
                        <div class="card" style="background-color: transparent;">
                            <div class="card-body">
                                <img src="{{ asset('weather-assets') }}/rain.svg" height="70" width="150">
                                <p class="text-center font-weight-bold" style="font-size: 9px;">Friday</p>
                                <p class="text-center font-weight-bold mt-4" style="font-size: 10px;">Chances of rainfall</p>
                                <p class="text-center font-weight-bold mt-2" style="font-size: 10px;">0.5%</p>
                            </div>
                        </div>
                        <div class="card" style="background-color: transparent;">
                            <div class="card-body">
                                <img src="{{ asset('weather-assets') }}/rain.svg" height="70" width="150">
                                <p class="text-center font-weight-bold" style="font-size: 9px;">Saturday</p>
                                <p class="text-center font-weight-bold mt-4" style="font-size: 10px;">Chances of rainfall</p>
                                <p class="text-center font-weight-bold mt-2" style="font-size: 10px;">0.5%</p>
                            </div>
                        </div>
